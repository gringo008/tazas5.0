document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadProducts() {
        const products = JSON.parse(localStorage.getItem('TAZONES.HTML')) || [];
    ...
    function saveProduct() {
        ...
        reader.onload = function(event) {
            ...
            localStorage.setItem('TAZONES.HTML', JSON.stringify(updatedProducts));
            loadProducts();
            resetForm();
        };
    ...
    function removeProduct(productId) {
        let products = JSON.parse(localStorage.getItem('TAZONES.HTML')) || [];
        products = products.filter(product => product.id !== productId);
        localStorage.setItem('TAZONES.HTML', JSON.stringify(products));
        loadProducts();
    }
